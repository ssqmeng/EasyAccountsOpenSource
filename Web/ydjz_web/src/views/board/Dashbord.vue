<template>
  <div>
    ...
    <van-divider :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }"> 储蓄卡
    </van-divider>
    <van-cell-group>
    ...
    <van-divider :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }"> 信用卡
    </van-divider>
    <van-cell-group>
    ...
    <van-divider :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }"> 投资账户
    </van-divider>
    <van-cell-group>
    ...
    <van-divider :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }"> 其他账户
    </van-divider>
    <van-cell-group>
